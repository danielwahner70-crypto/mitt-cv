...
<body class="bg-slate-900 text-slate-100 font-sans min-h-screen pb-12">
    ...
    <header class="max-w-4xl mx-auto pt-12 px-6 text-center">
        <div class="w-36 h-36 mx-auto mb-4 relative overflow-hidden rounded-full border-4 border-indigo-500 shadow-xl bg-slate-800 flex items-center justify-center">
            <img src="dw.jpg" alt="Daniel Wahnér" class="w-full h-full object-cover">
        </div>
